...
export const Clients = () => (
  <div className="my-16">
    <p className="relative mb-12 text-center text-lg text-white md:text-xl">
      <span className="text-primary-text">
        Powering the world’s best product teams.
      </span>
      <br className="hidden md:block" /> From next-gen startups to established
      enterprises.
      <div className="bg-gradient-to-r absolute inset-0 z-50 from-white/5 via-white to-white blur-lg" />
    </p>
